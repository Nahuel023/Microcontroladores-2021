...
#define I2C_H_
	...
	uint8_t I2C_ErrorCode;		// variable for communication error at twi
	...
	void i2c_start(uint8_t i2c_addr);	// send i2c_start_condition //leer o escribir - direccion
